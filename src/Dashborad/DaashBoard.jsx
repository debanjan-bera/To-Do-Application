...
export const DashBoard = () => {
  ...
  return (
    <DataProvider>
      <UserFormData>
        <section
          className={`h-dvh w-lvw bg-[#0B0D0E] grid ${ isMobile? "grid-cols-1": isTablet? "grid-cols-[12rem_3fr]": "grid-cols-[12rem_3fr_20rem]"} grid-rows-[0.35fr_3fr_0.2fr]`}>
          <section
            className={`w-full px-4 border-b-[0.02rem]  border-neutral-700 ${
              isMobile ? "col-start-1 col-end-2" : "col-start-2 col-end-4 row-start-1 row-end-2" }  text-2xl font-medium text-white flex justify-center flex-row`}
          >
          ...
          <section className={`w-full h-full bg-[#000000] border  border-zinc-700   ${
              isMobile ? "col-start-1 col-end-2 row-start-2 row-end-3 overflow-hidden" : " col-start-2 col-end-3 row-start-2 row-end-4"
            }  text-white `}
          >
