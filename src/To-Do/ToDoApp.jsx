...
export const TodoApp = () => {
  ...
  return (
    <>
      <main className="col-start-2 col-end-3 row-start-2 row-end-5 grid grid-cols[1fr] grid-rows-[0.2fr_3fr] overflow-hidden rounded-t-2xl bg-[#15161A] border netbackground"
      // style={{
