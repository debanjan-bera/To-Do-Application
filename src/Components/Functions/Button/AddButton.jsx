...
export const MobileAddTaskButton =({addTask})=>{
  ...
  const handleAddTaskWindow = (event)=>{
    ...
    return(
      <div className="wrapper h-[60px] w-[60px] absolute bottom-16 right-5 cursor-pointer" >
          ...
          <div className='h-[60px] w-[60px] text-2xl font-bold rounded-full absolute top-0 left-[-4rem] bg-blue-700 flex items-center justify-center'>6</div>
      </div>
    )
}
