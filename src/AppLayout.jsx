...
import { DataProvider } from "./Contexts/DataWhereHouse";
 const AppLayout=()=>{
  ...
  return (
    <>
      <main className={`cont h-lvh w-lvw grid ${sideBarClass} grid-rows-[0.3fr_0.3fr_3fr_0.2fr] gap-2  relative bg-neutral-200`}>
        <nav className="head row-start-1 row-end-2 col-start-2 col-end-4 bg-white">
